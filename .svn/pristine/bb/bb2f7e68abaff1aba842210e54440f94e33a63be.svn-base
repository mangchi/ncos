...
public class AssetController {
	...
	public ResponseEntity<Map<String,Object>> getAssetDispList(@RequestBody Map<String,Object> param,HttpServletRequest req) throws Exception{
		Map<String,Object> result = new HashMap<>();
		result.put("list", assetService.getAssetDispList(param));
	...
	//@Page
	@PostMapping("/getAssetAllList")
	public ResponseEntity<Map<String,Object>> getAssetAllList(@RequestBody Map<String,Object> param,HttpServletRequest req) throws Exception{
		Map<String,Object> result = new HashMap<>();
		result.put("list", assetService.getAssetAllList(param));
		Map<String,Object> appendData = new HashMap<>();
		appendData.put("listAssetStatus", assetService.getListAssetStatus(param));
		appendData.put("listAssetAffair", assetService.getListAssetAffair(param));
		result.put("appendData", appendData);
		return ResponseEntity.ok().body(result);
	}
