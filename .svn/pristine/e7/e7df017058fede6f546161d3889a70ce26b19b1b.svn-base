...
public class NetController {
	...
	public ResponseEntity<Map<String,Object>> getEventList(@RequestBody Map<String,Object> param,HttpServletRequest req) throws Exception{
	...
	public ResponseEntity<Map<String,Object>> getNetEquipList(@RequestParam Map<String,Object> param,HttpServletRequest req) throws Exception{
		Map<String,Object> result = new HashMap<>();
