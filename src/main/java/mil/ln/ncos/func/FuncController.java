...
public class FuncController {
	...
	public ModelAndView funcDisp(Model model, HttpServletRequest req) {
		...
		if (activeProfile.equals("hmmLand") || activeProfile.equals("lnsystemHmmLand")) {
	...
	public ResponseEntity<Map<String, Object>> getFuncList(@RequestBody Map<String, Object> param,
	...
	public ResponseEntity<Map<String, Object>> getShipStatusList(@RequestParam Map<String, Object> param,
			HttpServletRequest req) throws Exception {
		Map<String, Object> result = new HashMap<>();
